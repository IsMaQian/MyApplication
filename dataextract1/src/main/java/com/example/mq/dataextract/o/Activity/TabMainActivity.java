...
import com.example.mq.dataextract.o.Service.BlueToothService;
...
//        Intent flyStyleintent = new Intent(this, FlyStyleActivity.class);
//        TabHost.TabSpec flyStyleSpec = tabHost.newTabSpec("style");
//        flyStyleSpec.setIndicator("飞机类型");
//        flyStyleSpec.setContent(flyStyleintent);
//        tabHost.addTab(flyStyleSpec);
//        Intent zuoYeintent = new Intent(this, ZuoyeActivity.class);
//        TabHost.TabSpec zuoyeSpec = tabHost.newTabSpec("zuoye");
//        zuoyeSpec.setIndicator("作业参数");
//        zuoyeSpec.setContent(zuoYeintent);
//        tabHost.addTab(zuoyeSpec);
...
//                        FlyStyleActivity.setText(notice);
                        break;
                }
            }
        };
