...
public class CircleSeekBar extends View {
    ...
    private static final int CircleSeekBar_progress_width = 1;
	private static final int CircleSeekBar_progress_max = 4;
	private static final int CircleSeekBar_progress_front = 3;
	private static final int CircleSeekBar_progress_background = 2;
	private static final int CircleSeekBar_android_thumb = 0;
	public static final int[] CircleSeekBar = {
        0x01010142, 0x7f010000, 0x7f010001, 0x7f010002,
        0x7f010003, 0x7f010004, 0x7f010005, 0x7f010006,
        0x7f010007
    };
	private static final int CircleSeekBar_show_progress_text = 5;
	private static final int CircleSeekBar_progress_text_stroke_width = 6;
	private static final int CircleSeekBar_progress_text_color = 7;
	private static final int CircleSeekBar_progress_text_size = 8;
    ...
    private void initView(){
        ...
        TypedArray localTypedArray = mContext.obtainStyledAttributes(mAttrs, CircleSeekBar);
        
      
        mThumbDrawable = localTypedArray.getDrawable(CircleSeekBar_android_thumb);
        ...
        float progressWidth = localTypedArray.getDimension(CircleSeekBar_progress_width, 5);
        int progressBackgroundColor = localTypedArray.getColor(CircleSeekBar_progress_background, Color.GRAY);
        int progressFrontColor = localTypedArray.getColor(CircleSeekBar_progress_front, Color.BLUE);
        mSeekBarMax = localTypedArray.getInteger(CircleSeekBar_progress_max, 100);
        ...
        mIsShowProgressText = localTypedArray.getBoolean(CircleSeekBar_show_progress_text, false);
        int progressTextStroke = (int) localTypedArray.getDimension(CircleSeekBar_progress_text_stroke_width, 5);
        int progressTextColor = localTypedArray.getColor(CircleSeekBar_progress_text_color, Color.GREEN);
        mProgressTextSize = (int) localTypedArray.getDimension(CircleSeekBar_progress_text_size, 50);
    ...
    private void seekTo(float eventX, float eventY, boolean isUp) {
        if (true == isPointOnThumb(eventX, eventY) && false == isUp) {
            ...
            /*
             * 鐢变簬atan2杩斿洖鐨勫�间负[-pi,pi]
             * 鍥犳闇�瑕佸皢寮у害鍊艰浆鎹竴涓嬶紝浣垮緱鍖洪棿涓篬0,2*pi]
             */
            if (radian < 0){
