...
//      	sTemp = (short)(prop_ki_y * 100.0);
//    	TxData[21] = (byte)((sTemp&0xFF00)>>8);
//    	TxData[22]=(byte)(sTemp&0x00FF);
//    	CalcBcc(TxData,22);
//    	writeRXCharacteristic(TxData);
//    }
//    public void CalcBcc(byte[] TxData, int nByte)
//    { // 计算校验和
//    	
//    	 short sBcc = 0;
//    	
//    	for(int i=2;i<=nByte;i++) sBcc += (TxData[i] & 0x00FF);
//
